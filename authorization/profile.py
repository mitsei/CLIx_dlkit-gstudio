"""GStudio osid profile elements for authorization service packages"""
# -*- coding: utf-8 -*-
...
DISPLAYNAME = 'GStudio authorization'

DESCRIPTION = 'GStudio based authorization implementation'
