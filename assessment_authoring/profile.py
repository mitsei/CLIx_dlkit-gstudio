"""GStudio osid profile elements for assessment.authoring service packages"""
# -*- coding: utf-8 -*-
...
DISPLAYNAME = 'GStudio assessment.authoring'

DESCRIPTION = 'GStudio based assessment.authoring implementation'
