"""GStudio osid profile elements for authentication service packages"""
# -*- coding: utf-8 -*-
...
DISPLAYNAME = 'GStudio authentication'

DESCRIPTION = 'GStudio based authentication implementation'
